...
video_file = "resources/videos/out2.mp4"
output_file = "output_skeleton_overlay_aligned.mp4"

# ==========================
# Alignment Parameters
# ==========================
# Align video frame 46 (0-indexed) with mocap frame 10475 (0-indexed)
# The prompt states frame 46 starting from 1, so it's index 45 in a 0-indexed array
VIDEO_ALIGN_FRAME = 45 # Frame 46 (0-indexed is 45)
MOCAP_ALIGN_FRAME = 10475 # MoCap frame 10475 (0-indexed is 10474)
